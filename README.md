...
### v3.25.3 : 2026/07/09
- [調整] カードブロック：yStandard利用時にブロック使用ページ以外でもCSSをロードするように調整
- [調整] β見出しブロック：

### v3.25.2 : 2026/05/25
- [調整] β見出しブロック：フォント設定の追加、余白設定の追加

### v3.25.1 : 2026/05/22

- [追加] セクションブロック、カラムブロック、条件付きグループブロックで右設定パネルに子ブロックの一覧を表示できるように調整
- [調整] 旧カスタムボタンのスタイル調整、カスタムボタンへの変換調整

### v3.25.0 : 2026/05/17

- [調整] WordPress 7.0に向けた調整
- [調整] contentOnlyパターン内での編集に向けた各ブロックの属性調整
- [調整] iframeエディター内でのスタイル読み込み調整
- [追加] Pattern Overrides対応に向けたBlock Bindings対応属性の追加

### v3.24.0 : 2026/05/11

- [調整] カードブロック / セクションブロック：v2 → v3 ブロックへの移行
- [調整] ブロックエディターのスタイル読み込みに関する警告対処
- [調整] ウィジェット編集画面での警告対処

### v3.23.0 : 2026/02/05
- [調整] リンク設定の「新しいタブで開く」設定時のrel属性自動追加の削除
  - カスタムボタンブロック
  - カラムブロック
  - カードブロック
  - アイコンブロック
- [調整] カスタムボタンブロック：これまでβ版としていたボタンブロックを正規版に変更、旧ボタンブロックを非推奨に変更
- [調整] 非推奨カスタムボタンブロック：廃止時期の暫定的な決定：2027年2月末頃予定
- [調整] ボタン型リンクブロック：廃止時期の決定：2026年8月末頃予定
- [調整] yStandard Blocksメニューページのレイアウト調整

### v3.22.0 : 2025/12/18
- [追加] 吹き出しブロック：アバター名 文字サイズ調整機能追加

### v3.21.0 : 2025/12/05
- [調整] WordPress 6.9に向けた調整
...
- [調整] アイコンブロック：編集画面UI仕様変更
- [追加] アイコンブロック：アイコンサイズのレスポンシブ指定追加
- [調整] アイコンブロック：アイコン倍率の削除
- [追加] アイコンブロック：背景色・アイコンボックスサイズ・枠線・角丸設定追加

### v3.18.3 : 2025/09/29

- [修正] カスタムボタンブロック：文字サイズ指定の不具合修正
- [修正] 吹き出しブロック：文字サイズ指定の不具合修正
...
- [追加] カスタムボタンブロック：左右アイコンに空アイコンを追加するオプションの追加
- [修正] カスタムボタンブロック：角丸に0を設定するとブロックのエラーが出る点の修正
- [調整] カスタムボタンブロック：余白のデフォルト値調整

### v3.18.0 : 2025/06/05

- [追加] カスタムボタンブロック：新ボタンブロックのβ版追加

### v3.17.1 : 2025/05/15

- [修正] ブロックの色変更コントロールで値の直接入力が反映されなくなることがある不具合の修正

### v3.17.0 : 2025/04/18

- [調整] WordPress 6.8に向けた調整

### v3.16.4 : 2025/03/18

- [修正] yStandardテーマのブログカードショートコード連携不具合修正
- [調整] カードブロック：設定欄のスタイル調整

### v3.16.3 : 2025/01/29

- [修正] ウィジェット編集画面での不具合対処（見出しブロック・吹き出しブロック）

### v3.16.2 : 2024/12/19

- [調整] カラムブロック：gap設定でスライダーを使用した時に単位がつかないことがある問題の対応

### v3.16.1 : 2024/12/18

- [修正] 見出しブロック：編集画面でサブテキスト入力欄に背景色がついている問題の対処
- [修正] 見出しブロック：編集画面でサブテキスト入力の中央・右寄せの不具合修正
- [修正] 見出しブロック：編集画面での余白設定調整
