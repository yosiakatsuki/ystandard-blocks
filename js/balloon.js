...
/*!**********************************!*\
  !*** ./blocks/balloon/config.js ***!
  \**********************************/
/*! exports provided: attributes, supports, balloonTypes, balloonPositions, alignBottom, alignCenter, alignTop, alignmentsControls */
...
function ysBalloon(props) {
  ...
  }, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames3, avatarBorderColor.class, avatarBorderColor.class), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames3, 'has-border', 0 < avatarBorderWidth), _classnames3));
  /**
   * アバター画像スタイル
   *
   * @type {{borderColor: *}}
  ...
  var balloonBodyClass = classnames__WEBPACK_IMPORTED_MODULE_2___default()('ystdb-balloon__body', (_classnames4 = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames4, backgroundColor.class, backgroundColor.class), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames4, balloonBorderColor.class, balloonBorderColor.class), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames4, 'has-background', backgroundColor.color), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames4, "is-".concat(verticalAlign), verticalAlign), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames4, "is-".concat(balloonPosition), balloonPosition), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames4, "is-".concat(balloonType), balloonType), _classnames4));
  /**
   * 吹き出しスタイル
   *
  ...
  var textClasses = classnames__WEBPACK_IMPORTED_MODULE_2___default()('ystdb-ystdb-balloon__text', (_classnames5 = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames5, textColor.class, textColor.class), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames5, 'has-text-color', textColor.color), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames5, fontSize.class, fontSize.class), _classnames5));
  /**
   * 吹き出しテキストスタイル
   *
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__["BlockControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__["Toolbar"], {
    ...
    className: 'ystdb-balloon__avatar'
...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_4__["registerBlockType"])('ystdb/balloon', {
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('[ys]吹き出し', 'ystandard-blocks'),
  description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('yStandard Blocks 吹き出しブロック', 'ystandard-blocks'),
  icon: {
    src: 'format-chat',
    foreground: _src_js_config_config__WEBPACK_IMPORTED_MODULE_0__["ystdbConfig"].color.iconForeground
  },
  keywords: [Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('balloon'), Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('吹き出し'), 'balloon'],
...
function save(_ref) {
  ...
  var avatarClasses = classnames__WEBPACK_IMPORTED_MODULE_2___default()('ystdb-balloon__avatar-image', (_classnames2 = {
    'has-border-color': avatarBorderColorClass || customAvatarBorderColor
  }, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames2, avatarBorderColorClass, avatarBorderColorClass), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames2, 'has-border', 0 < avatarBorderWidth), _classnames2));
  /**
   * アバター画像スタイル
   *
   * @type {{borderColor: *}}
  ...
  var avatarNameClass = classnames__WEBPACK_IMPORTED_MODULE_2___default()('ystdb-balloon__name', (_classnames3 = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames3, avatarNameColorClass, avatarNameColorClass), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames3, 'has-text-color', customAvatarNameColor || avatarNameColorClass), _classnames3));
  /**
   * アバター名スタイル
   *
   * @type {{color: *}}
  ...
  var balloonBodyClass = classnames__WEBPACK_IMPORTED_MODULE_2___default()('ystdb-balloon__body', (_classnames4 = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames4, backgroundColorClass, backgroundColorClass), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames4, 'has-background', backgroundColorClass || customBackgroundColor), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames4, 'has-border-color', balloonBorderColorClass || customBalloonBorderColor), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames4, "is-".concat(verticalAlign), verticalAlign), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames4, "is-".concat(balloonPosition), balloonPosition), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames4, "is-".concat(balloonType), balloonType), _classnames4));
  /**
   * 吹き出しスタイル
   *
   * @type {{backgroundColor: *}}
  ...
  var textClasses = classnames__WEBPACK_IMPORTED_MODULE_2___default()('ystdb-balloon__text', (_classnames5 = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames5, textClass, textClass), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames5, 'has-text-color', textColor || customTextColor), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_classnames5, fontSizeClass, fontSizeClass), _classnames5));
  /**
   * 吹き出しテキストスタイル
   *
   * @type {{color: (*), fontSize: (string|*)}}
