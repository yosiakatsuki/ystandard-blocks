  ...
  const updateInlineItem = value => {
    ...
    if ((0,_aktk_helper_object__WEBPACK_IMPORTED_MODULE_9__.hasKey)(newValue, selectedItem)) {
      newValue[selectedItem] = {
        ...(0,_aktk_helper_object__WEBPACK_IMPORTED_MODULE_9__.getProperty)(items, selectedItem),
        ...value
      };
    }
    setItems(newValue);
...
const ToolbarButtons = () => {
  ...
  const updateButtonsOption = value => {
    setButtons({
      ...
      ...{
        [currentButtonIndex]: {
          ...(0,_aktk_helper_object__WEBPACK_IMPORTED_MODULE_9__.getProperty)(buttons, currentButtonIndex),
          ...value
        }
      }
    });
...
const getColorSlug = function (color) {
  let colors = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
...
const getBackGroundStyle = function (backgroundColor) {
  let gradient = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
  if (gradient) {
    return gradient;
  }
  if (backgroundColor !== null && backgroundColor !== void 0 && backgroundColor.color) {
