...
/* harmony import */ var _ystd_helper_admin_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ystd/helper/admin-menu */ "./src/js/helper/admin-menu.js");
...
const Balloon = () => {
  const options = (0,_ystd_helper_admin_menu__WEBPACK_IMPORTED_MODULE_3__.getOption)('balloon', false, []);
  ...
  const updateOption = function (data) {
    ...
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default()({
      path: (0,_ystd_helper_admin_menu__WEBPACK_IMPORTED_MODULE_3__.getEndpoint)('update'),
      method: 'POST',
      data
    }).then(response => {
      if ((0,_ystd_helper_admin_menu__WEBPACK_IMPORTED_MODULE_3__.isApiSuccess)(response.status)) {
...
(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.render)((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Balloon, null), document.getElementById((0,_ystd_helper_admin_menu__WEBPACK_IMPORTED_MODULE_3__.getConfig)('pageId')));
...
const AvatarMediaUpload = props => {
  ...
  const defaultAvatar = (0,_ystd_helper_config__WEBPACK_IMPORTED_MODULE_3__.getComponentConfig)('defaultAvatar').url;
...
const DeleteItemButton = props => {
  ...
  const avatar = !(item !== null && item !== void 0 && item.image) ? (0,_ystd_helper_config__WEBPACK_IMPORTED_MODULE_4__.getComponentConfig)('defaultAvatar').url : item.image;
  const [isModalOpen, setIsModalOpen] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
...
/* harmony import */ var _ystd_helper_boolean__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ystd/helper/boolean */ "./src/js/helper/boolean.js");
...
const BalloonItem = props => {
  ...
  const isEnable = () => {
    ...
    return (0,_ystd_helper_boolean__WEBPACK_IMPORTED_MODULE_7__.toBool)(enable);
  };
