...
/* harmony import */ var _ystd_config_config_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ystd/config/config.js */ "./src/js/config/config.js");
...
const cardEdit = props => {
  ...
  const updateUrl = value => {
    ...
    if (!!value && -1 === value.indexOf(ystdb.homeUrl)) {
      setAttributes({
        linkTarget: '_blank',
        rel: _ystd_config_config_js__WEBPACK_IMPORTED_MODULE_1__.ystdbConfig.button.newTabRel
      });
    } else {
      setAttributes({
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onChange: value => {
      ...
      if (newLinkTarget && !rel) {
        updatedRel = _ystd_config_config_js__WEBPACK_IMPORTED_MODULE_1__.ystdbConfig.button.newTabRel;
      } else if (!newLinkTarget && rel === _ystd_config_config_js__WEBPACK_IMPORTED_MODULE_1__.ystdbConfig.button.newTabRel) {
...
/* harmony default export */ __webpack_exports__["default"] = ((0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_7__.compose)([(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.withColors)('backgroundColor', 'borderColor', {
  titleColor: 'color',
  dscrColor: 'color',
  domainColor: 'color'
})])(cardEdit));
