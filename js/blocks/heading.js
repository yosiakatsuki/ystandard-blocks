...
/* harmony default export */ __webpack_exports__["default"] = ((0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_5__.compose)([(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.withColors)({
  textColor: 'color',
  subTextColor: 'color',
  dividerColor: 'fill'
...
class HeadingToolbar extends _wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Component {
  createLevelControl(targetLevel, selectedLevel, onChange) {
    ...
    return {
      ...
      title: `${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('見出し', 'ystandard-blocks')} ${targetLevel}`,
      isActive,
