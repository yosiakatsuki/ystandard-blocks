...
/* harmony import */ var _aktk_components_svg_icon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @aktk/components/svg-icon */ "./src/js/components/svg-icon/index.js");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _aktk_components_responsive_number_control_functions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @aktk/components/responsive-number-control/functions */ "./src/js/components/responsive-number-control/functions.js");
/* harmony import */ var _aktk_components_responsive_font_size_functions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @aktk/components/responsive-font-size/functions */ "./src/js/components/responsive-font-size/functions.js");
/* harmony import */ var _aktk_util_getResponsivPropertye__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @aktk/util/_getResponsivPropertye */ "./src/js/util/_getResponsivPropertye.js");
...
const deprecated2101 = [{
  ...
  save(_ref) {
    ...
    const wrapClasses = classnames__WEBPACK_IMPORTED_MODULE_2___default()('wp-block-button', {
      ...
      ...(0,_aktk_components_responsive_font_size_functions__WEBPACK_IMPORTED_MODULE_6__.getFontResponsiveClass)(isFontSizeResponsive, fontSizeDesktop, fontSizeTablet, fontSizeMobile)
    });
    const wrapStyles = {
      fontSize: !fontSizeClass && customFontSize && !isFontSizeResponsive ? customFontSize + 'px' : undefined,
      ...(0,_aktk_components_responsive_font_size_functions__WEBPACK_IMPORTED_MODULE_6__.getFontResponsiveStyle)({
    ...
    const linkClasses = classnames__WEBPACK_IMPORTED_MODULE_2___default()('wp-block-button__link', 'ystdb-button__link', {
      ...
      [`has-animation--${animationType}`]: 'none' !== animationType,
      ...(0,_aktk_components_responsive_number_control_functions__WEBPACK_IMPORTED_MODULE_5__.getPaddingResponsiveClass)({
    ...
    const linkStyles = {
      ...
      ...(0,_aktk_components_responsive_number_control_functions__WEBPACK_IMPORTED_MODULE_5__.getPaddingResponsiveStyle)({
        isResponsive: isPaddingVerticalResponsive,
        desktop: paddingVerticalDesktop,
        tablet: paddingVerticalTablet,
        mobile: paddingVerticalMobile,
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
      ...
      target: linkTarget,
      rel: rel
    }, (0,_aktk_util_getResponsivPropertye__WEBPACK_IMPORTED_MODULE_7__["default"])({
    ...
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_aktk_components_svg_icon__WEBPACK_IMPORTED_MODULE_3__["default"], {
      name: iconLeft
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "deprecated27": () => (/* binding */ deprecated27)
/* harmony export */ });
...
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! classnames */ "./node_modules/classnames/index.js");
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _aktk_components_svg_icon_select_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @aktk/components/svg-icon-select/index */ "./src/js/components/svg-icon-select/index.js");
/* harmony import */ var _aktk_components_svg_icon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @aktk/components/svg-icon */ "./src/js/components/svg-icon/index.js");
...
/* harmony import */ var _aktk_components_responsive_number_control_index__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @aktk/components/responsive-number-control/index */ "./src/js/components/responsive-number-control/index.js");
/* harmony import */ var _aktk_components_responsive_number_control_functions__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @aktk/components/responsive-number-control/functions */ "./src/js/components/responsive-number-control/functions.js");
...
/* harmony import */ var _aktk_components_responsive_font_size_functions__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @aktk/components/responsive-font-size/functions */ "./src/js/components/responsive-font-size/functions.js");
/* harmony import */ var _aktk_components_horizon_buttons__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @aktk/components/horizon-buttons */ "./src/js/components/horizon-buttons/index.js");
...
function svgButton(props) {
  ...
  const wrapClasses = classnames__WEBPACK_IMPORTED_MODULE_1___default()(className, 'wp-block-button', {
    ...
    ...(0,_aktk_components_responsive_font_size_functions__WEBPACK_IMPORTED_MODULE_13__.getFontResponsiveClass)(isFontSizeResponsive, fontSizeDesktop, fontSizeTablet, fontSizeMobile)
  });
  const wrapStyles = {
    fontSize: fontSize.size && !isFontSizeResponsive ? fontSize.size : undefined,
    ...(0,_aktk_components_responsive_font_size_functions__WEBPACK_IMPORTED_MODULE_13__.getFontResponsiveStyle)({
      isResponsive: isFontSizeResponsive,
      desktop: fontSizeDesktop,
      tablet: fontSizeTablet,
      mobile: fontSizeMobile
  ...
  const linkClasses = classnames__WEBPACK_IMPORTED_MODULE_1___default()('wp-block-button__link', 'ystdb-button__link', {
    ...
    'has-animation': animationType && 'none' !== animationType,
    [`has-animation--${animationType}`]: 'none' !== animationType,
    ...(0,_aktk_components_responsive_number_control_functions__WEBPACK_IMPORTED_MODULE_11__.getPaddingResponsiveClass)({
      isResponsive: isPaddingVerticalResponsive,
      desktop: paddingVerticalDesktop,
      tablet: paddingVerticalTablet,
      mobile: paddingVerticalMobile,
  ...
  const linkStyles = {
    ...
    paddingRight: !isPaddingHorizontalResponsive && paddingHorizontalDesktop ? paddingHorizontalDesktop : undefined,
    paddingLeft: !isPaddingHorizontalResponsive && paddingHorizontalDesktop ? paddingHorizontalDesktop : undefined,
    ...(0,_aktk_components_responsive_number_control_functions__WEBPACK_IMPORTED_MODULE_11__.getPaddingResponsiveStyle)({
      isResponsive: isPaddingVerticalResponsive,
      desktop: paddingVerticalDesktop,
      tablet: paddingVerticalTablet,
      mobile: paddingVerticalMobile,
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.BlockControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.AlignmentToolbar, {
    ...
    colorSettings: [{
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)('背景色', 'ystandard-blocks')
    }, {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__._x)('左アイコンサイズ', 'ystandard-blocks')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_aktk_components_horizon_buttons__WEBPACK_IMPORTED_MODULE_14__["default"], null, _src_js_config_config__WEBPACK_IMPORTED_MODULE_4__.ystdbConfig.icon.size.map(item => {
    ...
    className: "ystdb-inspector-controls__label"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__._x)('右アイコンサイズ', 'ystandard-blocks')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_aktk_components_horizon_buttons__WEBPACK_IMPORTED_MODULE_14__["default"], null, _src_js_config_config__WEBPACK_IMPORTED_MODULE_4__.ystdbConfig.icon.size.map(item => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.Button, {
      key: item.value,
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.BaseControl, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_aktk_components_responsive_font_size_index__WEBPACK_IMPORTED_MODULE_9__["default"], {
    id: 'font-size',
  ...
  }, "\u30DC\u30BF\u30F3\u5185\u5074\u306E\u4F59\u767D\u8A2D\u5B9A"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.BaseControl, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_aktk_components_responsive_number_control_index__WEBPACK_IMPORTED_MODULE_10__["default"], {
    ...
    max: 500,
    step: 1
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_aktk_components_responsive_number_control_index__WEBPACK_IMPORTED_MODULE_10__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_7__.compose)([(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.withColors)('backgroundColor', {
  textColor: 'color'
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getPaddingResponsiveClass": () => (/* binding */ getPaddingResponsiveClass),
/* harmony export */   "getPaddingResponsiveStyle": () => (/* binding */ getPaddingResponsiveStyle)
/* harmony export */ });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ResponsiveNumberControl);
...
/* harmony import */ var _aktk_util_icons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @aktk/util/icons */ "./src/js/util/icons.js");
/* harmony import */ var _aktk_components_svg_icon__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @aktk/components/svg-icon */ "./src/js/components/svg-icon/index.js");
...
class IconSelect extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  render() {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, !!selectedIcon && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_aktk_components_svg_icon__WEBPACK_IMPORTED_MODULE_5__["default"], {
      name: selectedIcon
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      ...
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_aktk_components_svg_icon__WEBPACK_IMPORTED_MODULE_5__["default"], {
        name: icon.name
      }));
    }))));
  }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.compose)([(0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.withState)({
  isOpen: false
})])(IconSelect));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Link2);
