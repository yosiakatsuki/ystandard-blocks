...
function ColumnsEditContainer(props) {
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.useBlockProps)({
    ...
    style: { ...(0,_aktk_components_responsive_spacing__WEBPACK_IMPORTED_MODULE_5__.getResponsiveMarginStyle)(margin)
    }
  });
  const columnsProps = {
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('ystdb-columns', {
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(_ref) {
  ...
  const blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps.save({
    className: 'ystdb-columns-wrap',
    style: { ...(0,_aktk_components_responsive_spacing__WEBPACK_IMPORTED_MODULE_3__.getResponsiveMarginStyle)(margin)
    }
  });
  const columnBlocksProps = {
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('ystdb-columns', {
