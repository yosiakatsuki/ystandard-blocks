...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _ystd_components_box_control__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ystd/components/box-control */ "./src/js/components/box-control/index.js");
/* harmony import */ var _ystd_components_responsive_tab__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ystd/components/responsive-tab */ "./src/js/components/responsive-tab/index.js");
/* harmony import */ var _ystd_components_responsive_values_info__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ystd/components/responsive-values-info */ "./src/js/components/responsive-values-info/index.js");
...
/* harmony import */ var _ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ystd/helper/responsive */ "./src/js/helper/responsive.js");
/* harmony import */ var _ystd_helper_spacing__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ystd/helper/spacing */ "./src/js/helper/spacing.js");
/* harmony import */ var _ystd_helper_object__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ystd/helper/object */ "./src/js/helper/object.js");
/* harmony import */ var _ystd_helper_gap_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ystd/helper/gap.js */ "./src/js/helper/gap.js");
...
const ResponsiveSpacing = props => {
  ...
  const _units = units !== null && units !== void 0 ? units : (0,_ystd_helper_config__WEBPACK_IMPORTED_MODULE_6__.getComponentConfig)('units');

  const valueDesktop = (0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_7__.getResponsiveValue)(values, 'desktop');
  const valueTablet = (0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_7__.getResponsiveValue)(values, 'tablet');
  const valueMobile = (0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_7__.getResponsiveValue)(values, 'mobile');

  const handleOnChangeDesktop = nextValues => {
    onChange((0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_7__.parseResponsiveValues)({ ...values,
      desktop: (0,_ystd_helper_spacing__WEBPACK_IMPORTED_MODULE_8__.parseSpacing)(nextValues)
    }));
  };

  const handleOnChangeTablet = nextValues => {
    onChange((0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_7__.parseResponsiveValues)({ ...values,
      tablet: (0,_ystd_helper_spacing__WEBPACK_IMPORTED_MODULE_8__.parseSpacing)(nextValues)
    }));
  };

  const handleOnChangeMobile = nextValues => {
    onChange((0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_7__.parseResponsiveValues)({ ...values,
      mobile: (0,_ystd_helper_spacing__WEBPACK_IMPORTED_MODULE_8__.parseSpacing)(nextValues)
    }));
  };

  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_responsive_tab__WEBPACK_IMPORTED_MODULE_4__["default"], {
    label: label
  }, tab => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, _ystd_components_responsive_tab__WEBPACK_IMPORTED_MODULE_4__.tabType.desktop === tab.name && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: 'ystd-responsive-spacing-box-control'
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_box_control__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    })), _ystd_components_responsive_tab__WEBPACK_IMPORTED_MODULE_4__.tabType.tablet === tab.name && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: 'ystd-responsive-spacing-box-control'
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_box_control__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      inputProps: inputProps,
      splitOnAxis: splitOnAxis
    })), _ystd_components_responsive_tab__WEBPACK_IMPORTED_MODULE_4__.tabType.mobile === tab.name && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: 'ystd-responsive-spacing-box-control'
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_box_control__WEBPACK_IMPORTED_MODULE_3__["default"], {
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_responsive_values_info__WEBPACK_IMPORTED_MODULE_5__["default"], {
    desktop: (0,_ystd_helper_spacing__WEBPACK_IMPORTED_MODULE_8__.getSpacingInfo)(valueDesktop),
    tablet: (0,_ystd_helper_spacing__WEBPACK_IMPORTED_MODULE_8__.getSpacingInfo)(valueTablet),
    mobile: (0,_ystd_helper_spacing__WEBPACK_IMPORTED_MODULE_8__.getSpacingInfo)(valueMobile),
    style: {
      marginTop: 0
    }
  }));
...
const getResponsiveSpacingStyle = function (type, values) {
  ...
  const parsedValue = (0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_7__.parseResponsiveValues)({
    desktop: (0,_ystd_helper_spacing__WEBPACK_IMPORTED_MODULE_8__.getSpacingProps)(type, values === null || values === void 0 ? void 0 : values.desktop),
    tablet: (0,_ystd_helper_spacing__WEBPACK_IMPORTED_MODULE_8__.getSpacingProps)(type, values === null || values === void 0 ? void 0 : values.tablet),
    mobile: (0,_ystd_helper_spacing__WEBPACK_IMPORTED_MODULE_8__.getSpacingProps)(type, values === null || values === void 0 ? void 0 : values.mobile)
  });
  return (0,_ystd_helper_object__WEBPACK_IMPORTED_MODULE_9__.parseObject)(getResponsiveSpacingCustomProperty(parsedValue, suffix));
};
const getResponsiveGapStyle = function (values) {
  let suffix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  return (0,_ystd_helper_object__WEBPACK_IMPORTED_MODULE_9__.parseObject)(getResponsiveGapCustomProperty(values, suffix));
};
