...
const ResponsiveSpacing = props => {
  ...
  const handleOnChangeDesktop = nextValues => {
    onChange((0,_aktk_helper_responsive__WEBPACK_IMPORTED_MODULE_8__.parseResponsiveValues)({ ...values,
...
const getResponsiveSpacingCustomProperty = function (value) {
  ...
  return { ...getCustomProperty(value === null || value === void 0 ? void 0 : value.desktop, 'desktop', (0,_aktk_helper_responsive__WEBPACK_IMPORTED_MODULE_8__.isResponsive)(value), suffix),
...
const getResponsiveGapCustomProperty = function (value) {
  ...
  return { ...getCustomProperty((0,_aktk_helper_gap_js__WEBPACK_IMPORTED_MODULE_11__.getGapProperty)(value === null || value === void 0 ? void 0 : value.desktop), 'desktop', (0,_aktk_helper_responsive__WEBPACK_IMPORTED_MODULE_8__.isResponsive)(value), suffix),
