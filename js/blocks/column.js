...
const ResponsiveToggle = _ref => {
  ...
  const handleOnChangeDesktop = value => {
    onChange((0,_aktk_helper_responsive__WEBPACK_IMPORTED_MODULE_4__.parseResponsiveValues)({ ...values,
...
const ResponsiveValues = _ref => {
  ...
  const handleOnChangeDesktop = value => {
    onChange((0,_aktk_helper_responsive__WEBPACK_IMPORTED_MODULE_6__.parseResponsiveValues)({ ...values,
      desktop: value || undefined
    }));
  };
