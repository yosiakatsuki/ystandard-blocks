...
const deprecated__34__migrationPadding = [{ ...metadata,
...
function migratePadding(attributes) {
  if (!(attributes !== null && attributes !== void 0 && attributes.paddingType)) {
    return attributes;
  }
  ...
  Object.keys(oldPadding).map(key => {
    ...
    if (key === ((_newAttributes = newAttributes) === null || _newAttributes === void 0 ? void 0 : _newAttributes.paddingType)) {
      var _newAttributes2;
...
/* harmony import */ var _ystd_components_responsive_values__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ystd/components/responsive-values */ "./src/js/components/responsive-values/index.js");
...
function ColumnEdit(props) {
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
    ...
    style: {
      ...
      ...(0,_ystd_components_responsive_spacing__WEBPACK_IMPORTED_MODULE_4__.getResponsivePaddingStyle)(padding),
      ...(0,_ystd_components_responsive_values__WEBPACK_IMPORTED_MODULE_5__.getResponsiveWidthStyle)(width),
      ...(0,_ystd_components_responsive_values__WEBPACK_IMPORTED_MODULE_5__.getResponsiveValueStyle)('flex-basis', width)
    }
  });
  const containerProps = {
    className: 'ystdb-column-block-container'
...
/* harmony export */ });
/* harmony import */ var _ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ystd/helper/responsive */ "./src/js/helper/responsive.js");

const getAutoWidthClasses = isAutoWidth => {
  const desktop = (0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_0__.getResponsiveValue)(isAutoWidth, 'desktop');
  const tablet = (0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_0__.getResponsiveValue)(isAutoWidth, 'tablet');
  const mobile = (0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_0__.getResponsiveValue)(isAutoWidth, 'mobile');
  return {
...
/* harmony default export */ __webpack_exports__["default"] = (ColumnInspectorControls);
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _ystd_controls_responsive_padding_control__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ystd/controls/responsive-padding-control */ "./src/js/controls/responsive-padding-control/index.js");
...
const PanelPadding = _ref => {
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_controls_responsive_padding_control__WEBPACK_IMPORTED_MODULE_3__["default"], {
    values: padding,
...
/* harmony import */ var _ystd_components_responsive_toggle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ystd/components/responsive-toggle */ "./src/js/components/responsive-toggle/index.js");
...
/* harmony import */ var _ystd_helper_object_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ystd/helper/object.js */ "./src/js/helper/object.js");
...
const AutoWidth = _ref => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_responsive_toggle__WEBPACK_IMPORTED_MODULE_2__["default"], {
  ...
  }), (0,_ystd_helper_object_js__WEBPACK_IMPORTED_MODULE_4__.isObject)(isAutoWidth) && (0,_ystd_helper_object_js__WEBPACK_IMPORTED_MODULE_4__.isObject)(width) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_notice__WEBPACK_IMPORTED_MODULE_3__["default"], {
    type: _ystd_components_notice__WEBPACK_IMPORTED_MODULE_3__.noticeType.warning
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _ystd_components_responsive_values__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ystd/components/responsive-values */ "./src/js/components/responsive-values/index.js");
...
const Width = _ref => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_responsive_values__WEBPACK_IMPORTED_MODULE_2__["default"], {
...
/* harmony import */ var _ystd_components_responsive_values__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ystd/components/responsive-values */ "./src/js/components/responsive-values/index.js");
...
function save(_ref) {
  ...
  const blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps.save({
    ...
    style: {
      backgroundColor: customBackgroundColor ? customBackgroundColor : undefined,
      ...(0,_ystd_components_responsive_spacing__WEBPACK_IMPORTED_MODULE_3__.getResponsivePaddingStyle)(padding),
      ...(0,_ystd_components_responsive_values__WEBPACK_IMPORTED_MODULE_4__.getResponsiveWidthStyle)(width),
      ...(0,_ystd_components_responsive_values__WEBPACK_IMPORTED_MODULE_4__.getResponsiveValueStyle)('flex-basis', width)
    }
  });
  const containerProps = {
    className: 'ystdb-column-block-container'
...
/* harmony import */ var _ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ystd/helper/responsive */ "./src/js/helper/responsive.js");
...
const ResponsiveToggle = _ref => {
  ...
  const valueDesktop = (0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_4__.getResponsiveValue)(values, 'desktop');
  const valueTablet = (0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_4__.getResponsiveValue)(values, 'tablet');
  const valueMobile = (0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_4__.getResponsiveValue)(values, 'mobile');

  const handleOnChangeDesktop = value => {
    onChange((0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_4__.parseResponsiveValues)({ ...values,
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.BaseControl, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_responsive_tab__WEBPACK_IMPORTED_MODULE_3__["default"], {
    label: panelLabel
  }, tab => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, _ystd_components_responsive_tab__WEBPACK_IMPORTED_MODULE_3__.tabType.desktop === tab.name && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.ToggleControl, {
      label: toggleLabel,
      checked: !!valueDesktop,
      onChange: value => {
        handleOnChangeDesktop(value);
      }
    }), _ystd_components_responsive_tab__WEBPACK_IMPORTED_MODULE_3__.tabType.tablet === tab.name && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.ToggleControl, {
      label: toggleLabel,
      checked: !!valueTablet,
      onChange: value => {
        handleOnChangeTablet(value);
      }
    }), _ystd_components_responsive_tab__WEBPACK_IMPORTED_MODULE_3__.tabType.mobile === tab.name && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.ToggleControl, {
      label: toggleLabel,
      checked: !!valueMobile,
      onChange: value => {
...
/* harmony import */ var _ystd_components_unit_control__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ystd/components/unit-control */ "./src/js/components/unit-control/index.js");
/* harmony import */ var _ystd_components_responsive_values_info__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ystd/components/responsive-values-info */ "./src/js/components/responsive-values-info/index.js");
/* harmony import */ var _ystd_components_button_reset__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ystd/components/button-reset */ "./src/js/components/button-reset/index.js");
/* harmony import */ var _ystd_components_flex__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ystd/components/flex */ "./src/js/components/flex/index.js");
/* harmony import */ var _ystd_helper_object_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ystd/helper/object.js */ "./src/js/helper/object.js");
...
const ResponsiveValues = _ref => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.BaseControl, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_responsive_tab__WEBPACK_IMPORTED_MODULE_4__["default"], {
    label: label
  }, tab => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, _ystd_components_responsive_tab__WEBPACK_IMPORTED_MODULE_4__.tabType.desktop === tab.name && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_flex__WEBPACK_IMPORTED_MODULE_10__.Flex, {
      isGapSmall: true,
      alignBottom: true
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_unit_control__WEBPACK_IMPORTED_MODULE_7__["default"], {
      ...
      onChange: handleOnChangeDesktop,
      units: _units
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_button_reset__WEBPACK_IMPORTED_MODULE_9__["default"], {
      isDisable: !valueDesktop,
      onClick: () => {
        handleOnChangeDesktop(undefined);
      }
    })), _ystd_components_responsive_tab__WEBPACK_IMPORTED_MODULE_4__.tabType.tablet === tab.name && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_flex__WEBPACK_IMPORTED_MODULE_10__.Flex, {
      isGapSmall: true,
      alignBottom: true
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_unit_control__WEBPACK_IMPORTED_MODULE_7__["default"], {
      className: 'ystd-responsive-values-unit-control',
    ...
    })), _ystd_components_responsive_tab__WEBPACK_IMPORTED_MODULE_4__.tabType.mobile === tab.name && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_flex__WEBPACK_IMPORTED_MODULE_10__.Flex, {
      isGapSmall: true,
      alignBottom: true
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_unit_control__WEBPACK_IMPORTED_MODULE_7__["default"], {
      className: 'ystd-responsive-values-unit-control',
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ystd_components_responsive_values_info__WEBPACK_IMPORTED_MODULE_8__["default"], {
...
/* harmony default export */ __webpack_exports__["default"] = (ResponsiveValues);
...
const getCustomProperties = function (propertyName, values) {
  ...
  if (!(0,_ystd_helper_object_js__WEBPACK_IMPORTED_MODULE_11__.isObject)(values)) {
    return undefined;
  }

  if (!(0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_6__.isResponsive)(values)) {
    return {
      [(0,lodash__WEBPACK_IMPORTED_MODULE_1__.camelCase)(propertyName)]: values === null || values === void 0 ? void 0 : values.desktop
    };
  }
...
const getResponsiveValueStyle = function (propertyName, values) {
  ...
  const parsedValue = (0,_ystd_helper_responsive__WEBPACK_IMPORTED_MODULE_6__.parseResponsiveValues)({
    desktop: values === null || values === void 0 ? void 0 : values.desktop,
    tablet: values === null || values === void 0 ? void 0 : values.tablet,
    mobile: values === null || values === void 0 ? void 0 : values.mobile
  });
  return (0,_ystd_helper_object_js__WEBPACK_IMPORTED_MODULE_11__.parseObject)(getCustomProperties(propertyName, parsedValue, suffix));
};
