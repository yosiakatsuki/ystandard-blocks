...
import ResponsiveNumberControl from '@aktk/components/responsive-number-control/index';
import {
	...
	return (
		<Fragment>
			...
			<InspectorControls>
				...
				<PanelBody
					title={ __( 'ブロックタイプ設定', 'ystandard-blocks' ) }
				>
					<BaseControl>
						<ToggleControl
