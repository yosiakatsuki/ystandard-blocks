        ...
        <InspectorControls>
          ...
          <PanelBody title={ __( "カード表示設定", "ystandard-blocks" ) }>
            <BaseControl>
              ...
              <ColorPaletteControl
                label={ __( "カード背景色", "ystandard-blocks" ) }
              ...
              <ColorPaletteControl
                label={ __( "カード枠線色", "ystandard-blocks" ) }
          ...
          >
            <BaseControl>
              ...
              <ColorPaletteControl
                label={ __( "タイトル文字色", "ystandard-blocks" ) }
          ...
          >
            <BaseControl>
              ...
              <ColorPaletteControl
                label={ __( "概要 文字色", "ystandard-blocks" ) }
