		...
		if ( ! imageUrl || defaultAvatar === imageUrl ) {
			return (
				...
				>
					...
					<span className="ystdb-menu-balloon__avatar-media-upload-select-hover">画像を選択</span>
				</Button>
			);
		} else {
			return (
				...
				>
					...
					<span className="ystdb-menu-balloon__avatar-media-upload-select-hover">画像を削除</span>
				</Button>
			);
		}
	};
