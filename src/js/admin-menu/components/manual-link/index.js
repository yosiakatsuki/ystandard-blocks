...
const ManualLink = ( props ) => {
	...
	return (
		<div className={ classnames(
			'ystdb-component-manual-link',
			{
				'is-top-right': topRight
			}
		) }>
			<a href={ url } target={ linkTarget }>
				<span className="ystdb-component-manual-link__icon"><Book size={ 12 }/></span>
				<span className="ystdb-component-manual-link__text">{ linkText }</span>
			</a>
		</div>
	);
};
